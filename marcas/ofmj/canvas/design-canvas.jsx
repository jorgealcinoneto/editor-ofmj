...
if (typeof document !== 'undefined' && !document.getElementById('dc-styles')) {
  ...
  s.textContent = [
    ...
    '.dc-expand:focus-visible,.dc-kebab:focus-visible,.dc-menu button:focus-visible{outline:2px solid #c96442;outline-offset:2px}',
      ...
      <div className="dc-header" data-omelette-chrome="" style={{ color: DC.label }} onPointerDown={(e) => e.stopPropagation()}>
        ...
        <div className="dc-btns">
          <div ref={menuRef} style={{ position: 'relative' }}>
            <button className="dc-kebab" type="button" title="Mais opções" aria-label="Mais opções" aria-haspopup="menu" aria-expanded={menuOpen} onClick={() => setMenuOpen((o) => !o)}>
              <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor" aria-hidden="true"><circle cx="2.5" cy="6" r="1.1"/><circle cx="6" cy="6" r="1.1"/><circle cx="9.5" cy="6" r="1.1"/></svg>
            </button>
            {menuOpen && (
              <div className="dc-menu" role="menu" onPointerDown={(e) => e.stopPropagation()}>
                <button type="button" role="menuitem" onClick={() => doExport('png')}>Download PNG (3×)</button>
                <button type="button" role="menuitem" onClick={() => doExport('html')}>Download HTML</button>
                <hr />
          ...
          <button className="dc-expand" type="button" onClick={onFocus} title="Focar slide" aria-label="Focar slide">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" aria-hidden="true"><path d="M7 1h4v4M5 11H1V7M11 1L7.5 4.5M1 11l3.5-3.5"/></svg>
          </button>
        </div>
      </div>
